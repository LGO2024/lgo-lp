...
const strengths = [
  {
    ...
    title: 'LGOマッチング',
    description:
      '深夜のファミレス会議中も、LINEのLGOが即座にヒアリング＆提案。幹事の熱量が高い瞬間にクロージングまで持っていきます。',
  },
  {
    icon: '🎬',
    title: '思い出の動画自動生成（完全無料）',
    description:
      'LGO経由で予約した団体には、旅行中の素材をアップロードするだけでプロ級の動画が完成する自動編集機能を無料で提供。',
  },
  {
    icon: '🎯',
    title: '選択回避の法則を応用した「究極の3択」',
    description:
      '膨大なプランの中からLGOが「あなたにはこの3つがベスト」と理由付きで絞り込み提案。迷う時間をゼロに。',
  },
]
